...
/***
 * 这也是android一个牛逼的地方，将所有可绘制的对象都抽象成drawable，提供通用的绘制方法
 * shapedrawable代表一个可绘制的形状，这些形状由shape规定，提供绘制到canvas的能力
 * 一般可以在xml进行定义，有系统将其解析为相应的drawable对象
 *
