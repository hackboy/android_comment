...
/***
 * 一个作为顶级窗口外观和行为的抽象基础策略，该类的实例应该作为添加到窗口管理
 * 的顶级视图，他提供了比如背景，标题，默认按键处理的标准ui策略
 */
//就是描述一个窗口的各种属性等
public abstract class Window {
    ...
    // 当前窗口的各种属性，由WindowManager.LayoutParams定义
    ...
    //定义一个扩展WindowManagerImpl.CompatModeWrapper的内部私有类
    private class LocalWindowManager extends WindowManagerImpl.CompatModeWrapper {
        ...
        //添加视图，给定布局参数，final方法，不得继承,也有一个addview方法，和windowmanager里的addview有关系吗？
    ...
    /***
     * 获取顶级窗口装饰view，包含标准的窗口边框和修饰，以及客户端内容，该view可以被
     * 作为窗口添加到窗口管理器
