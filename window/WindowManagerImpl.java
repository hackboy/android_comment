...
public class WindowManagerImpl implements WindowManager {
    ...
    //这些变量代表的是什么
    private View[] mViews;
    //一个viewrootimpl数组，说明该类和viewroot关系密切
    private ViewRootImpl[] mRoots;

    private WindowManager.LayoutParams[] mParams;

    private final static Object sLock = new Object();
    //我想知道如何实现和windowmanagerservice进行通信的
    //全局唯一，单例模式么
    ...
    //getDefault返回一个默认的windowmanager对象,饿汉式的单例模式
    ...
    //增加一个view对象，原来如此，马蛋，完全和windowmanagerservice没什么关系啊，当你调用该
    //方法时到底做了些什么  
    ...
    //addview的具体实现方法,在这个地方啊，确实，我去，好吧，我们经常调用的wm.addView做了什么
    //我们直接调用windowmanager的addview方法所得到的结果
    //也是viewroot里rootview的赋值过程
    private void addView(View view, ViewGroup.LayoutParams params, CompatibilityInfoHolder cih, boolean nest) {
        ...
        //必须传入windowmanager.layoutparams，否则会抛出错误
