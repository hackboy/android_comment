...
public class SurfaceView extends View {
    ...
    //为该view创建一个独立的surface，surface是由谁进行管理
    ...
    //创建一个handler，处理其他线程发送的消息，为什么不是static
    ...
    //返回一个对surfaceview中surface进行控制的surfaceholder
    ...
    //surfaceholder接口，内部实现了这个接口，匿名内部类
