...
/***
 * 程序和window manager service交互的接口
 * 包含了viewmanager接口，该接口用来添加，删除view
 */
//windowmanagerimpl实现了该接口定义的功能，看看windowmanager所要实现的功能有哪些
//主要是定义了窗口布局参数
//这是一个接口定义，其实现在xxx
public interface WindowManager extends ViewManager {
    ...
    //窗口布局参数
    //该参数真他娘的强大，规定了一个窗口的一切啊
    //而且还是静态的，我去，一切都靠你了
    //各种参数，利用这些参数，什么都能做，该参数需要进行在不同的进程间进行传递
    //马丹，全是参数,其实这个windowmanager和windowmanagerservice完全没有一点联系啊
