...
/***
 * 获取特定程序的activity和recevier信息，这些信息对应androidmainfest文件中注册的activity和recevier
 */
public class ActivityInfo extends ComponentInfo
     ...
     */
    //lanuch模式=======》standard    single_top   single_task   single_instance
     ...
     */
    //原来在此，如果activity没有则使用application定义的theme
