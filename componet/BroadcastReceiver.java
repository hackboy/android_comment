 ...
 */
//几乎是四大组件中最简单的，接受一个广播，做出相应，ok
//这个类和其他不同，没有独立的context
//系统如何处理广播，广播系统的架构是怎么样的
public abstract class BroadcastReceiver {
     ...
     */
    //为一个广播接收者结果状态，由goAsyc返回
    //该内部类是实现broadcastreceiver的关键
     ...
     */
    //该方法会在activitythread里被调用，因此其是在主线程被调用的
    //context是指该广播接收器运行的context
    //intent是该接收器接受到的intent
