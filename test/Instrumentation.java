...
//该类是如何做到检测的
//实现程序代码检测跟踪的基础类
//当在检测开启前提下运行时，该类会在程序代码执行前实例化，允许你监视程序和系统交互的一切活动
//需要在androidmanifest文件中注册
//系统将很多的组件级的运行委托给了该类
//今天对该类的运行机制进行学习，必须掌握====》2014.7.30
public class Instrumentation {
     ...
     */
    //在instrumentation创建时运行，其他代码都未开始运行
    ...
    public Activity startActivitySync(Intent intent) {
        ...
        synchronized (mSync) {
            ...
            //最终还是调用application的方法进行启动，感觉像是代理模式
