...
/***
 * 更新appwidget状态，获取已安装appwidget provider的信息和其他appwidget相关的状态
...
public class AppWidgetManager {
     ...
     */
    //为特定的appwidgetid设置remoteview,都是直接调用appwidgetservice的方法进行处理，涉及到远程通信
    ...
    /***
     * 返回当前安装安装的appwidget provider的列表
     */
     ...
     */
    //返回和指定appwidgetprovider绑定的appwidgetid列表
    //不懂不懂啊
