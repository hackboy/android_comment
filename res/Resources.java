...
/***
 * 该类构建于assetmanager类之上，提供了获取应用程序资源的高层次的api，一般可以得到特定类型的
 * 数据，而不是assetmanager的流数据
 * 通过getResources()获得该对象
 */
public class Resources {
    ...
    /***
     * 返回一个可以让你读取给定resource id的xml资源文件的xmlresourceparser。
    ...
    /***
     * 该类拥有特定主题的当前属性值，或者说，一个主题是一系列资源属性值的集合
     * 通过和typedarray一起使用得到一个属性的最终值
    ...
    public final class Theme {
        ...
        /***
         * 获取一个包含了由theme定义的在attrs列出的值的StyledAttributes
    ...
    //该类不能直接实例化是不可能的,这个一般供内部创建一个全局唯一系统的resources
    private Resources() {
