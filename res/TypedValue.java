...
public class TypedValue {
    //定义一些数据类型，用于标记数据类型，与那啥息息相关
    /*** The value contains no data. */
    public static final int TYPE_NULL = 0x00;

    //引用类型的值，<attr name="imageButtonStyle" format="reference" />例子
    //其值类型为一个引用类型<item name="imageButtonStyle">@android:style/Widget.ImageButton</item>
    //其值为@android:style/widget.ImageButton=============>
    /*
    ...
    */
    ...
    //值是一个属性？？？
    /*这是值  <item name="colorBackgroundCacheHint">?android:attr/colorBackground</item>
        这是一个属性<attr name="colorBackground" format="color" />
        这是一个确定的属性值<item name="colorBackground">@android:color/background_dark</item>
        ?android:attr/colorBackground代表其使用属性为colorBackground的值，也就是@android:color/background_dark
    */
    ...
    public static final String coerceToString(int type, int data)
    {
        ...
        case TYPE_NULL:
            return null;
        //对其他资源引用需要加一个@符号，比如@android:style/Widget.ImageButton这个值，其值为android:style/Widget.ImageButton
        //前面加上@就表示这是一个引用其他的值
        case TYPE_REFERENCE:
            //原来如此
            return "@" + data;
