...
/***
 * 显示任意的图片，比如图标。该类可以从各种资源获取图片，精确计算图片尺寸以便他能
 * 在不同的布局中使用，并提供一系列显示选项，比如缩放和着色
...
public class ImageView extends View {
    ...
    //这个允许其子类定义自己的样式？？真心不懂啊,现在懂了，这个没有默认样式，这个一般不会被外界调用
