...
public class SimpleAdapter extends BaseAdapter implements Filterable {
    //用于映射的各个元素,to和from代表的是数据到view之间的对应，所以顺序很重要
    //数据到视图对象的对应关系
    //需要赋予内容的view
    private int[] mTo;
    //对应数据项
    private String[] mFrom;
    //viewbinder的作用,数据到view内容的填充规则
    private ViewBinder mViewBinder;
    //以string为key的map列表，是simpleadapter包含的数据类型
     ...
     */
    //构造一个simpleadapter，包括数据 资源 以及定义对应关系，数据是一个列表，其中包含的是一个string到任意对象的map
