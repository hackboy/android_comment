...
//现在已经大致对这种方式理解了，该类是一个binder类，并实现了transfact的处理，我们只需要实现其中的方法即可
class NotificationManagerService extends INotificationManager.Stub
{
    ...
    // adb连接，usb连接等通知，系统预定义的几种通知情情形
    private boolean mUsbConnected;
    private boolean mAdbEnabled = false;
    private boolean mAdbNotificationShown = false;
    private Notification mAdbNotification;
    //一种是toast，一种是notification
    ...
    //定义广播接收器，接收通知消息，一些系统级别的通知，比如软件卸载，电量过低等
    ...
    // Toasts
    // ============================================================================
    //对toast的支持，注意toast的客户端实现，其实是将toast入队，从而维护toast的顺序
