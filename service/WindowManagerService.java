...
/*** {@hide} */
//不可见，该类很庞大，android窗口系统的核心
//该服务的作用是进行窗口管理，包括创建等等
//竟然是hide，对系统中所有的窗口进行管理并处理相关的任务
//该服务也比较复杂，其需要和很多其他的服务进行交互
public class WindowManagerService extends IWindowManager.Stub
    ...
    //看该线程的作用，启动wms并进行消息循环，实例化windowmanagerservice并进入消息循环
    ...
    //构建该服务
    private WindowManagerService(Context context, PowerManagerService pm,boolean haveInputMethods) {
        if (MEASURE_LATENCY) {
