...
//壁纸服务，又是一个服务,现在已经略懂了，，略懂略懂,IWallpaperManager.Stub是一个由aidl生成的
//能够进行ipc的静态内部类，继承于Binder并实现了IInterface接口
//已经为我们实现了进行远程通信的各个细节，我们要做的就是实现其中的抽象方法，专注于功能而不是
//一些重复的繁琐的通信细节
class WallpaperManagerService extends IWallpaperManager.Stub {
     ...
     * 当壁纸改变时应该收到通知的所有注册的回调列表，回调其实很简单哎
     */
    //这个貌似在wallpapermanager里进行了实现
