...
//这个类根本不是什么代理类，就是一个使用了代理类功能的平常类而已，我们完全可以自己写一个相似的类
//大部分功能直接调用getDefault方法得到的对象的功能
public class ActivityManager {
    ...
    public List<RecentTaskInfo> getRecentTasks(int maxNum, int flags)
        ...
        try {
            //其实该类什么都不是，我们也完全可以写一个这样的类，主要功能还是由activitymangagerservice提供
