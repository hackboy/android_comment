...
/***
 * 一个描述可以在其他进程展示的view结构，该结构从一个布局文件中导入
 * 且提供了一些可以修改该结构的基本操作，不是真正的view？？
...
public class RemoteViews implements Parcelable, Filter {
    ...
    /***
     * 包含该布局的包吗,要用到该包的很多资源啊
     * resource. (Added to the parcel)
     */
    private final String mPackage;
    
    /***
     * 该布局文件的资源id (Added to the parcel)
     */
     ...
     */
    //记录该remoteview所占用的内存，how，why，what，cao
